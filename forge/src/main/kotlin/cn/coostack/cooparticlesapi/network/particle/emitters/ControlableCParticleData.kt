...
open class ControlableCParticleData : ControlableParticleData() {
    ...
    companion object {
         ...
         */
        @JvmField
        val PACKET_CODEC: cn.coostack.cooparticlesapi.network.packet.api.CommonCodec<ControlableCParticleData> =
         ...
         */
        private fun encode(buf: PacketByteBuf, data: ControlableCParticleData) {
            encodeBase(buf, data)
         ...
         */
        private fun decode(buf: PacketByteBuf): ControlableCParticleData {
        ...
        private fun <T> writeNullable(
            buf: PacketByteBuf,
            value: T?,
            codec: cn.coostack.cooparticlesapi.network.packet.api.CommonCodec<T>,
        ) {
     ...
     * @return [PACKET_CODEC]
     */
    override fun getCodec(): cn.coostack.cooparticlesapi.network.packet.api.CommonCodec<ControlableCParticleData> = PACKET_CODEC
