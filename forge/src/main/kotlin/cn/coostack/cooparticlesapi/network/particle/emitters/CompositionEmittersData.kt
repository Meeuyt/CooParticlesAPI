...
class CompositionEmittersData(
    ...
    companion object {
        @JvmStatic
        val PACKET_CODEC: cn.coostack.cooparticlesapi.network.packet.api.CommonCodec<CompositionEmittersData> =
    ...
    private fun decodeComposition(): ParticleComposition {
        ...
        return codec.decode(PacketByteBuf(Unpooled.wrappedBuffer(compositionData.copyOf())))
    }
    ...
    override fun getCodec(): cn.coostack.cooparticlesapi.network.packet.api.CommonCodec<SerializableData> {
        return PACKET_CODEC
    }
