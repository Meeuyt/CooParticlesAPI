...
object EmittersShootTypes {
    ...
    private val types = HashMap<String, cn.coostack.cooparticlesapi.network.packet.api.CommonCodec<EmittersShootType>>()

    fun register(id: String, codec: cn.coostack.cooparticlesapi.network.packet.api.CommonCodec<EmittersShootType>) {
        types[id] = codec
    }
