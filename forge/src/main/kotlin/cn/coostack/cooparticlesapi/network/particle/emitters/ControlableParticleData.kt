...
open class ControlableParticleData : SerializableData {
    companion object {
        ...
        @JvmStatic
        val PACKET_CODEC: cn.coostack.cooparticlesapi.network.packet.api.CommonCodec<ControlableParticleData> =
    ...
    override fun getCodec(): cn.coostack.cooparticlesapi.network.packet.api.CommonCodec<ControlableParticleData> {
        return PACKET_CODEC
    }
