...
class PacketTerrainEffectGroupS2C() : CooPacket() {
    ...
    /** @return 编解码本协议全部操作类型的 CommonCodec。 */
    override fun codec(): cn.coostack.cooparticlesapi.network.packet.api.CommonCodec<PacketTerrainEffectGroupS2C> = CODEC
    ...
    companion object {
        ...
        private val CODEC: cn.coostack.cooparticlesapi.network.packet.api.CommonCodec<PacketTerrainEffectGroupS2C> =
