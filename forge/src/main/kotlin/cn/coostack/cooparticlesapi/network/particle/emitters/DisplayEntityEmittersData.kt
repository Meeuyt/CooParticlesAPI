...
class DisplayEntityEmittersData(
    ...
    companion object {
        @JvmStatic
        val PACKET_CODEC: cn.coostack.cooparticlesapi.network.packet.api.CommonCodec<DisplayEntityEmittersData> =
    ...
    private fun decodeEntity(registryAccess: RegistryAccess): DisplayEntity {
        ...
        return codec.decode(
            PacketByteBuf(Unpooled.wrappedBuffer(entityData.copyOf()), registryAccess)
        )
    }
